						...
						<div class="big-info" style="position: relative; top: -11px;">
							<div class="inf-left">
								<div class="gallery-block-one">
									...
									<div style="width: 260px; height: 262px; padding: 20px; background: rgb(51, 51, 51) none repeat scroll 0% 0%; margin-top: -262px; margin-left: 480px;" class="buy-block">
										<? if($GIFT['winner'] != ""){ ?>
										<div style="padding: 10px 20px;">
											...
											<a style="text-decoration: none;" href="<?=$GIFT['winner'];?>" target="_blank">
												...
												<div style="border-radius: 3px; padding: 5px; background: rgba(255, 255, 255, 0.09); height: 60px;">
													<img style="border-radius: 3px; position: relative; top: -10px;" class="avavk" src="<?=$obj['response'][0]['photo'];?>" />
													<div style="margin-left: 65px; margin-top: -42px; color: rgb(255, 255, 255); font-weight: bold; text-decoration: none; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; position: relative; top: -10px;"><?=$obj['response'][0]['first_name'].' '.$obj['response'][0]['last_name'];?></div>
												</div>
											</a>
										</div>
										<? } else { ?>
										...
										<div data-ulogin-inited="1452475801162" style="" id="uLogin" data-ulogin="display=buttons;fields=first_name,last_name,photo;providers=vkontakte;hidden=;redirect_uri=http://<?=$_SERVER['HTTP_HOST'];?><?=$_SERVER['REQUEST_URI'];?>">
											<button class="gift_enter" id="confirmbuttongifts" style="font: bold 15px/14px arial; position: relative;
left: 7px;" data-uloginbutton="vkontakte">Участвовать</button>
										</div>
										<? } ?>
									</div>
								</div>
								<div id="goods">
									<nav class="main-tabs" style="width: 740px; margin-top: 10px;">
				...
				<div class="buy-item">
					<div style="padding-left:10px; padding-right:10px;" class="buy-view">
						...
						<div class="row">
							...
							<div class="row-info">
								<a href="<?=$row['winner'];?>"></a>
								<div class="title1" style="position: relative; top: 12px;">
									<a href="<?=$row['image'];?>"></a>
									<a href="/gifts/<?=$row['gid'];?>" style="position: relative; bottom: 9px;"><?=$row['gift'];?></a>
								</div>
								<div class="category" style="position: relative; top: 4px;">
