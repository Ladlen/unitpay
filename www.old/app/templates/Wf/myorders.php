	<div id="content" style="position: relative; left: 2.5%; width: 60%; float: left;">
			...
			<div class="buy-item">
				<div class="buy-view">
					...
					<form class="form-inline">
						<input type="text" id="mydata1" class="inputtext" style="margin-top: 10px; width: 93%;" placeholder="Введите e-mail" name="email" />
