	...
	<div class="big-info">
		<div class="inf-left">
			<div class="gallery-block-one">
				...
				<div style="width: 195px; height: 280px; padding:20px; background: #333333; margin-top: -297px;" class="buy-block">
					<? if($GIFT['winner'] != ""){ ?>
					...
					<div style="margin-top: 15px;">  
						<button class="clicked" id="sharebutton" style="width: 193px;">Поделиться</button>
					...
					<div data-ulogin-inited="1452475801162" style="" id="uLogin" data-ulogin="display=buttons;fields=first_name,last_name,photo;providers=vkontakte;hidden=;redirect_uri=http://<?=$_SERVER['HTTP_HOST'];?><?=$_SERVER['REQUEST_URI'];?>">
						<button class="gift_enter" id="confirmbuttongifts" data-uloginbutton="vkontakte" style="width: 193px;">Участвовать</button>
					</div>
					<? } ?>
				</div>
			</div>
			<div id="goods">
				<nav class="main-tabs" style="width: 730px; margin-top: 10px;">
