			...
			<div class="middle_part_in">
				<div class="info-tabs ui-tabs">
					<ul class="menu__products">
						<li><center><a>Раздачи</a></li>
					</ul>
					<div class="detals" style="color:white;">
						<div class="big-info" style="position: relative; top: -11px;">
							<div class="inf-left">
								<div class="gallery-block-one">
									...
									<div style="width: 223px; height: 228px; padding: 20px; background: rgb(51, 51, 51) none repeat scroll 0% 0%; margin-top: -273px;
margin-left: 474px;" class="buy-block">
										<? if($GIFT['winner'] != ""){ ?>
										...
										<div data-ulogin-inited="1452475801162" style="" id="uLogin" data-ulogin="display=buttons;fields=first_name,last_name,photo;providers=vkontakte;hidden=;redirect_uri=http://<?=$_SERVER['HTTP_HOST'];?><?=$_SERVER['REQUEST_URI'];?>">
											<button class="gift_enter" id="confirmbuttongifts" style="font: bold 15px/24px arial;" data-uloginbutton="vkontakte">Участвовать</button>
										</div>
										<? } ?>
									</div>
								</div>
								<div id="goods">
									<nav class="main-tabs" style="width: 738px;">
