	<div id="container">
		...
		<div class="sider_center" style="width: 740px;">
			<div class="cblock">
				<div class="cb_title"> 	
					<div class="cb_titl">
						<h1><?=$PAGE['title'];?></h1>
						...
						<div class="big-info" style="position: relative; top: -11px;">
							<div class="inf-left">
								<div class="gallery-block-one">
									...
									<div style="width: 210px; height: 229px; padding: 20px; background: rgb(51, 51, 51) none repeat scroll 0% 0%; margin-top: -273px; margin-left: 468px;" class="buy-block">
										<? if($GIFT['winner'] != ""){ ?>
										...
										<div data-ulogin-inited="1452475801162" style="" id="uLogin" data-ulogin="display=buttons;fields=first_name,last_name,photo;providers=vkontakte;hidden=;redirect_uri=http://<?=$_SERVER['HTTP_HOST'];?><?=$_SERVER['REQUEST_URI'];?>">
											<button class="gift_enter" id="confirmbuttongifts" style="font: bold 15px/14px arial; width:190px; margin-left: 15px;" data-uloginbutton="vkontakte">Участвовать</button>
										</div>
										<? } ?>
									</div>
								</div>
								<div id="goods">
									<nav class="main-tabs" style="width: 718px; margin-top: 10px;">
					...
					<div style="display: block;" class="vf_desc current">
						<p>
							<div class="row">
								...
								<div class="row-info" style="background: white;">
									<a href="<?=$row['winner'];?>"></a>
									<div class="title">
										<a href="<?=$row['image'];?>"></a>
									...
									<div class="price" style="color:#999;"><?=Date("d.m.Y", $row['time']);?></div>
								</div>
							</div>
						</p>
					</div>
