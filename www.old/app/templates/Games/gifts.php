	...
	<article class="page-full">
		<div class="block-wrap idesc">
			<div class="big-info" style="width: 800px; margin: 0 auto; height: 900px;">
				<div class="inf-left">
					<div class="gallery-block-one">
						...
						<div style="width: 235px; height: 267px; padding:20px; background: #333333;" class="buy-block">
							<? if($GIFT['winner'] != ""){ ?>
	...
	<article class="page-full">
		<div class="block-wrap idesc">
			<center>
				<font color="white">Раздачи отсутствуют в базе данных.</font>
			</center>
		</div>
	</article>
	<? } ?>
