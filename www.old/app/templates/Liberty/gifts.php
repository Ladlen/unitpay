	<div id="container">
		...
		<div class="side_right">
			<div class="sider_center" style="width: 735px;">
				<aside class="sblock" style="height: 915px;">
					<div class="sb_title">
						<i class="ics ic_04"></i> <?=$GIFT['gift'];?>
					</div>
					<div class="sb_cont">
						<div class="layer">
							<div class="big-info" style="position: relative; top: -11px;">
								<div class="inf-left">
									<div class="gallery-block-one">
										...
										<div style="background: rgb(51, 51, 51) none repeat scroll 0% 0%; padding: 20px; height: 226px; width: 205px; margin-left: 480px;" class="buy-block">
											<? if($GIFT['winner'] != ""){ ?>
											<div style="padding: 10px 20px;">
												...
												<a style="text-decoration: none;" href="<?=$GIFT['winner'];?>" target="_blank">
													...
													<div style="border-radius: 3px; padding: 5px; background: rgba(255, 255, 255, 0.09); height: 52px;">
											...
											<div data-ulogin-inited="1452475801162" style="" id="uLogin" data-ulogin="display=buttons;fields=first_name,last_name,photo;providers=vkontakte;hidden=;redirect_uri=http://<?=$_SERVER['HTTP_HOST'];?><?=$_SERVER['REQUEST_URI'];?>">
												<button class="gift_enter" id="confirmbuttongifts" style="font: bold 15px/14px arial; width: 205px;" data-uloginbutton="vkontakte">Участвовать</button>
											</div>
											<? } ?>
										</div>
									</div>
									<div id="goods">
										<nav class="main-tabs" style="width: 725px; margin-top: 10px;">
