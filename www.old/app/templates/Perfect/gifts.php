		...
		<aside id="side-center">
			<div class="block-title1">
				<center><?=$GIFT['gift'];?></center>
			</div>
			<div class="big-info" style="position: relative; top: -11px;">
				<div class="inf-left">
					<div class="gallery-block-one">
						<div class="gallery" style="overflow: hidden; width: 475px; height: 272px;">
							<img src="<?=$GIFT['image'];?>" style="display: inline; height: 268px; width: 455px;">
						</div>
						<div class="buy-block" style="width: 275px; height: 267px; padding:20px; background: #333333; margin-left: 455px;">
							<? if($GIFT['winner'] != ""){ ?>
		...
		<aside id="side-center">
			...
			<div class="row">
				...
				<div class="row-info">
					...
					<div class="title">
						<a href="<?=$row['image'];?>"></a>
						<a href="/gifts/<?=$row['gid'];?>" style="position: relative; bottom: 7px;"><?=$row['gift'];?></a>
					</div>
					<div class="category">
