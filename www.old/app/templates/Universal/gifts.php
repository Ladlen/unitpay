			...
			<div class="over_cnt">
				<div class="cnt_in">
					<div class="goods-list with-clear">
						<?=$PAGE['body'];?>
						<div class="big-info" style="top: -11px; position: relative; margin: 0px auto; width: 845px;">
							<div class="inf-left">
								<div class="gallery-block-one">
									...
									<div style="width: 275px; height: 267px; padding:20px; background: #333333;" class="buy-block">
										...
										<div data-ulogin-inited="1452475801162" style="" id="uLogin" data-ulogin="display=buttons;fields=first_name,last_name,photo;providers=vkontakte;hidden=;redirect_uri=http://<?=$_SERVER['HTTP_HOST'];?><?=$_SERVER['REQUEST_URI'];?>">
											<button class="gift_enter" id="confirmbuttongifts" style="font: bold 15px/14px arial; margin-left:20px;" data-uloginbutton="vkontakte">Участвовать</button>
										</div>
										<? } ?>
									</div>
								</div>
								<div id="goods">
									<nav class="main-tabs" style="width: 810px; margin-top: -5px;">
