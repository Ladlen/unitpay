		...
		<div class="big-info" style="width: 771px; margin: 0px auto; position: relative; top: -11px;">
			<div class="inf-left">
				<div class="gallery-block-one">
					<div class="gallery" style="overflow: hidden; height: 267px; width: 520px;">
						<img src="<?=$GIFT['image'];?>" style="display: inline; width: 520px; height: 267px;">
					</div>
					<div class="buy-block" style="background: rgb(51, 51, 51) none repeat scroll 0% 0%; height: 267px; width: 290px; margin-top: -267px; margin-left: 515px; padding: 20px;">
						<? if($GIFT['winner'] != ""){ ?>
						<div style="padding: 10px 20px;">
							...
							<a style="text-decoration: none;" href="<?=$GIFT['winner'];?>" target="_blank">
								...
								<div style="border-radius: 3px; padding: 5px; background: rgba(255, 255, 255, 0.09) none repeat scroll 0% 0%; height: 60px;">
									<img style="border-radius: 3px;" class="avavk" src="<?=$obj['response'][0]['photo'];?>" />
									<div style="margin-left: 65px; text-decoration: none; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; font-weight: bold; margin-top: -42px; color: rgb(255, 255, 255); font-size: 9pt;"><?=$obj['response'][0]['first_name'].' '.$obj['response'][0]['last_name'];?></div>
								</div>
							</a>
						</div>
						<? } else { ?>
				...
				<div id="goods">
					<nav class="main-tabs" style="width: 806px; margin-top: 10px;">
