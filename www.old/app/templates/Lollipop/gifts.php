<div id="container">
		...
		<div class="layer">
			<div id="content">
				<div id="content-c" style="width: 790px;">
					<div class="layer">
						<div class="panel">
							<div class="panel-heading">
								<h3 class="panel-title"> Раздачи</h3>
							</div>
									...
									<div class="big-info" style="position: relative; top: -11px;">
										<div class="inf-left">
											<div class="gallery-block-one">
												...
												<div class="buy-block" style="width: 265px; height: 267px; padding: 20px; background: rgb(51, 51, 51) none repeat scroll 0% 0%;">
													<? if($GIFT['winner'] != ""){ ?>
											...
											<div id="goods">
												<nav class="main-tabs" style="width: 760px; margin-top: 10px;">
