	...
	<div class="popup" style="height: 350px;">
		...
		<div aria-hidden="false" class="modal fade in" id="paymodal" style="display: none; margin: 0px auto; overflow: hidden; position: absolute; width: 570px; top: 60px;">
			...
			<center>
				<table class="paytable" style="font-size: 16px;position: relative;top: -15px;width: 60%;">
					<tbody>
						<tr>
				...
				<div class="payfoot modal-footer" style="position: relative;top: 10px;">
					<input class="checkpaybtn btn-default pull-left" value="Проверить" data-loading-text="Проверяем..." class="checkpaybtn btn btn-primary" style="position: relative; width: 80%;" type="button" />
				</div>
			</center>
			<div style="color:#000000;padding: 10px 35px 10px 15px;margin-top: 37px;background-color: #E4D7D7;border: 1px solid #fbeed5;margin-left: 24px;border-radius: 4px;" class="alert alert-danger">
		...
		<div id="selectPay" style="display:block;">
			...
			<div style="margin-left: 56px;" id="paym" class="tabs"> 
				...
				<div id="<?=$name;?>" style="display: none;"> 
					<br />
					<center>
						<input type="submit" class="buy_game btn-default pull-left" onclick="setWayForMoney('<?=$name;?>'); setEmail();" id="setEmailButton" data-dismiss="modal" aria-hidden="true" data-toggle="modal" value="перейти к оплате" style="width: 427px;position: relative;right: -20px;top: -19px;" />	
					</center>
				</div>
				<? } ?>
				<? } ?>
	...
	<section class="container">
		<div class="goods_title-wrap">
			<h2 class="section-title"><?=$ITEM['item'];?></h2>
			<a href="#pay" class=" btn"><span><span>купить за <?=$price['WMR'];?> руб.</span></span></a> 	
		</div>
		...
		<div class="catalog goods">
			<div class="goods_left">
				<figure class="goods_img slider-pro sp-horizontal" style="width: 100%; max-width: 860px;">
					<div class="sp-slides-container">
						<div class="sp-mask sp-grab" style="width: 860px; height: 400px;">
							<div class="sp-slides" style="transform: translate3d(-870px, 0px, 0px);">
								<div class="sp-slide sp-selected" data-index="0" data-init="true" data-loaded="true" style="width: 860px; height: 400px; left: 870px;">
									<div class="sp-image-container" style="width: 860px; height: 400px;">
										<img class="sp-image" src=" <?=$ITEM['image'];?>" style="width: 100%; height: auto; margin-left: 0px; margin-top: -42px;">
									</div>
								</div>
							</div>
						</div>
