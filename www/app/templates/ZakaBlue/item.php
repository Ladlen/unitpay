		...
		<? $price = json_decode($ITEM['price'], true); ?>
			...
			<div class="center_div white_bg">
				<div class="game">
					<div id="gameSlider">
						<h1 style="font-size: 22px; position: relative; bottom: 10px;">Купить <?=$ITEM['item'];?></h1>
						<img src="<?=$ITEM['image'];?>" style="width: 562px; height: 327px;" />
					</div>
				</div>
				<ul id="gTabH">
					<li><a style="text-decoration: none;" href="javascript:void(0);" id="gTabA0">Описание</a></li>
				</ul>
				<div id="gTab">
					<span class="vk_like"><span id="vk_like"></span></span>
					<div id="gTabI0">
						<h1>Описание</h1>
						<?=$ITEM['body'];?>
					</div>
