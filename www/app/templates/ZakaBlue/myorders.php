	<DIV class="center_div white_bg">
		<div id="content" style="width: 93%; margin: 0 auto;">
				...
				<div class="buy-item">
					<div class="buy-view">
						...
						<form class="form-inline">
							<input type="text" id="mydata1" class="inputtext" style="margin-top: 10px; width: 94.5%;" placeholder="Введите e-mail" name="email" />
