		...
		<div class="inf-left">
			<div class="gallery-block-one">
				...
				<div style="width: 275px; height: 267px; padding:20px; background: #333333;" class="buy-block">
					...
					<div style="margin-top: 15px;">  
						<button class="clicked" id="sharebutton" style="margin-left: -20px;">Поделиться</button>
						<button style="display: none;" id="confirmbutton" onclick="confirmgift();" style="margin-left: -20px;">Участвовать</button>
					</div>
					...
					<div data-ulogin-inited="1452475801162" style="" id="uLogin" data-ulogin="display=buttons;fields=first_name,last_name,photo;providers=vkontakte;hidden=;redirect_uri=http://<?=$_SERVER['HTTP_HOST'];?><?=$_SERVER['REQUEST_URI'];?>">
						<button class="gift_enter" id="confirmbuttongifts" style="margin-left: -20px;" data-uloginbutton="vkontakte">Участвовать</button>
					</div>
					<? } ?>
				</div>
			</div>
