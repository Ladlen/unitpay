	<div id="container">
		...
		<div class="big-info" style="position: relative; top: -2px;">
			<div class="inf-left">
				<div class="gallery-block-one">
					<div class="gallery" style="overflow: hidden; height: 271px;">
						<img src="<?=$GIFT['image'];?>" style="display: inline; height: 255px; width: 407px; margin-left: 6px;">
					</div>
					<div class="buy-block" style="width: 224px; height: 215px; padding: 20px; background: rgb(51, 51, 51) none repeat scroll 0% 0%; margin-left: 417px;">
						<? if($GIFT['winner'] != ""){ ?>
						...
						<div style="margin-top: 15px;">  
							<button class="clicked" id="sharebutton" style="margin-left: -4px;">Поделиться</button>
						...
						<div data-ulogin-inited="1452475801162" style="" id="uLogin" data-ulogin="display=buttons;fields=first_name,last_name,photo;providers=vkontakte;hidden=;redirect_uri=http://<?=$_SERVER['HTTP_HOST'];?><?=$_SERVER['REQUEST_URI'];?>">
							<button class="gift_enter" id="confirmbuttongifts" style="font: bold 15px/14px arial; margin-right: -5px;" data-uloginbutton="vkontakte">Участвовать</button>
						</div>
						<? } ?>
					</div>
				</div>
				<div id="goods">
					<nav class="main-tabs" style="width: 675px; margin-top: -15px; margin-left: 6px;">
		...
		<br/><div class="row">
			...
			<div class="row-info">
				...
				<div class="category">
					<img class="avavk" src="<?=$obj['response'][0]['photo'];?>" style="height: 15px; width: 15px;">
