	<div id="middle" class="cnt clr">
		...
		<div id="content">
			<div class="catalog white-cnt">
				...
				<div class="good_top">
					<div class="good_img">
						<img src="<?=$ITEM['image'];?>" class="gphoto big" id="ipreview">
					</div>
					<div class="good_info">
						<div class="g_price">
							<?=$ITEM['item'];?>
						...
						<div class="g_buttons">
							<span class="id-good-12-price"><?=$price['WMR'];?> руб.</span>
						</div>
						<ul class="shop-options" id="id-12-options" style="margin-top: 15px;">
							<a href="#pay">
								<input class="buy_game" id="setEmailButton" data-dismiss="modal" aria-hidden="true" data-toggle="modal" value="Купить" type="button" />
							</a>
						</ul>
					</div>
				</div>
				<div id="tabs" class="aTabs">
					<div class="aTabsHead">
						<span class="aTabsHeadSpanActive">Описание</span>
					</div>
					<ul>
						<li style="display: list-item;"><?=$ITEM['body'];?> </li>
					</ul>
				</div>
			</div>
		</div>
