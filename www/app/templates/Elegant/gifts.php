		...
		<div id="middle" class="cnt clr">
			<div id="content">
				<div id="new-items" class="white-cnt">
					<h2 class="title">Раздача </h2>
					<div class="goods-list with-clear">
						<div class="big-info" style="position: relative; top: -11px;">
							<div class="inf-left">
								<div class="gallery-block-one">
									<div class="gallery" style="overflow: hidden; width: 495px; height: 287px;">
										<img src="<?=$GIFT['image'];?>" style="display: inline; width: 495px; height: 288px;">
									</div>
									<div class="buy-block" style="width: 295px; height: 247px; padding: 20px; background: rgb(51, 51, 51) none repeat scroll 0% 0%; margin-top: -287px; margin-left: 495px;">
										<? if($GIFT['winner'] != ""){ ?>
										...
										<div data-ulogin-inited="1452475801162" style="" id="uLogin" data-ulogin="display=buttons;fields=first_name,last_name,photo;providers=vkontakte;hidden=;redirect_uri=http://<?=$_SERVER['HTTP_HOST'];?><?=$_SERVER['REQUEST_URI'];?>">
											<button class="gift_enter" id="confirmbuttongifts" style="font: bold 15px/24px arial; margin-left: 30px;" data-uloginbutton="vkontakte">Участвовать</button>
										</div>
										<? } ?>
									</div>
								</div>
								<div id="goods">
									<nav class="main-tabs" style="width: 830px; margin-top: 10px;">
