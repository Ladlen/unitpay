	<div id="content" style="width: 90%; position: relative; right: 5.5%;">
			...
			<div class="buy-item">
				<div class="buy-view">
					...
					<form class="form-inline">
						<input type="text" id="mydata1" class="inputtext" style="margin-top: 10px; width: 95.5%;" placeholder="Введите e-mail" name="email" />
