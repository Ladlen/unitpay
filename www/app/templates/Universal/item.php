		...
		<div id="selectPay" style="display:block;">
			...
			<div style="margin-left: 56px;" id="paym" class="tabs"> 
				...
				<form onsubmit="return false;">
					...
					<input style="margin-top: -45px; width: 109px; margin-left: 327px;" name="count" id="end-number"  class="captcha-shop-input" placeholder="Кол-во" required="">
			...
			<div class="h_shat">
				<div class="h_shat_image">
					<div class="h_shat_image_in">
						<img src="<?=$ITEM['image'];?>" class="gphoto">
					</div>
				</div>
				<div class="h_shat_text">
					<div class="h_title" style="border-bottom-width: 2px; border-bottom-style: solid; border-bottom-color: rgba(32, 46, 43, 0.8);"><?=$ITEM['item'];?></div>
...
<?=$ITEM['body'];?>
					<div class="h_s_price" style="float:right;"><span class="id-good-10-price"><?=$price['WMR'];?> руб.</span></div><br/><br/>
					<ul class="shop-options" id="id-10-options">
						<a href="#pay">
							<input class="h_s_buy" id="setEmailButton" data-dismiss="modal" aria-hidden="true" data-toggle="modal" value="Купить" type="button" style="margin-right: -84px;">
						</a>
					</ul>
				</div>
			</div>
