	<div id="container">
		...
		<aside id="side-center">
			<div class="full-content">
				<div class="lcol">
					<div class="b-top yellow"><?=$GIFT['gift'];?></div>
							...
							<div class="big-info" style="position: relative; top: -11px;">
								<div class="inf-left">
									<div class="gallery-block-one">
										...
										<div style="width: 265px; background: rgb(51, 51, 51) none repeat scroll 0% 0%; height: 267px; padding: 20px;" class="buy-block">
											<? if($GIFT['winner'] != ""){ ?>
											...
											<div data-ulogin-inited="1452475801162" style="" id="uLogin" data-ulogin="display=buttons;fields=first_name,last_name,photo;providers=vkontakte;hidden=;redirect_uri=http://<?=$_SERVER['HTTP_HOST'];?><?=$_SERVER['REQUEST_URI'];?>">
												<button class="gift_enter" id="confirmbuttongifts" style="font: bold 15px/14px arial; margin-left: -4px;" data-uloginbutton="vkontakte">Участвовать</button>
											</div>
											<? } ?>
										</div>
									</div>
									<div id="goods">
										<nav class="main-tabs" style="width: 761px; margin-top: 10px;">
		...
		<aside id="side-center">
			<div class="full-content">
				<div class="lcol">
					<div class="b-top yellow">Раздачи</div>
					<div id="full-item-info">
						<div class="tab-box cur" style="display: block;">
							<div class="row">
